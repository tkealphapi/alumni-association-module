...
const HouseplateColor = ({ width, height }: SvgProps) => {
  return (
    <svg
      version='1.1'
      id='svg2'
    ...
    >
      <defs id='defs6'>
        <clipPath clipPathUnits='userSpaceOnUse' id='clipPath16'>
          <path d='M 0,108 H 144 V 0 H 0 Z' id='path14' />
        </clipPath>
      </defs>
        ...
        <g id='g10'>
          <g id='g12' clipPath='url(#clipPath16)'>
            ...
            <path
              ...
              style={{ fill: '#bf2519', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }}
              id='path20'
            />
            <path
...
export default HouseplateColor
